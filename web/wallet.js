...
function eligibility(){$('sign').disabled=attempted||!$('authorize').checked||record?.status!=='READY_FOR_SIGNATURE'||Date.now()-record.finalQuote.startedAt>15000;}
